<script setup lang="ts">
    ...
    const exampleApplications = ref(exampleApplicationsJSON)
    const applicationFields = ref(applicationFieldsArray)

    console.log(exampleApplicationsJSON)
</script>
    ...
    <div class="h-fit p-5 flex-1 flex flex-col">
        <div class="search-add-bar-wrapper h-32 flex flex-row">
            <div class="search-bar-wrapper my-auto">
                <input type="text" placeholder="Search" class="search-bar text-4xl border-2 py-2 px-4 border-black rounded-full font-genos font-black"/>
            </div>
        ...
        <div class="information-section-wrapper flex-1 flex flex-col">
            ...
            <div class="information-wrapper flex flex-col flex-1">
                <div v-for="applications in exampleApplications" class="grid grid-cols-8 bg-white font-genos">
                    ...
                    <div class="col-span-1 text-2xl p-2 border-r border-b border-black flex"> 
                        <div class="m-auto flex-1 text-center">
                            {{ applications.date_applied.getDate() }}
                        </div>
                    </div>
                    <div class="col-span-1 text-2xl p-2 border-r border-b border-black flex"> 
                        <div class="m-auto flex-1 text-center">
                    ...
                    <div class="col-span-1 text-2xl p-2 border-r border-b border-black flex"> 
                        <div class="m-auto flex-1 text-center">
                            <!-- <a href={{ applications.link }}> link</a> -->
                        </div>
                    </div>
                </div>
            </div>
